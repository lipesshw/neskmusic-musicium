...
const dirSetup = [{
			"Folder": "Informacões", "CmdName": "Informacões",
			"CmdDescription": "Conceda informações específicas sobre algo."
	},{
			"Folder": "Configuracão", "CmdName": "Configuracão",
			"CmdDescription": "Ajuste as configurações do bot."
	},{
			"Folder": "Musica", "CmdName": "musica",
			"CmdDescription": "Informações sobre o bot."
	},{
			"Folder": "Fila", "CmdName": "Fila",
			"CmdDescription": "Comandos de fila."
	},{     
		"Folder": "Filtros", "CmdName": "filtros",
		"CmdDescription": "Adicione filtros à sua música."
	}];
