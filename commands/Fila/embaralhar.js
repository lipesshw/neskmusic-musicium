...
module.exports = {
	name: "embaralhar", //the command name for the Slash Command

	category: "Fila",
	aliases: ["misturar"],
	usage: "embaralhar",

	description: "Embaralhe as músicas da fila.", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`🔀 | ${newQueue.songs.length} músicas embaralhadas por \`${member.user.tag}\`!`)]
				})
			} catch (e) {
