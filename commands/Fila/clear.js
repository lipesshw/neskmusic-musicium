...
module.exports = {
	...
	description: "Limpe a fila.", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setDescription(`<:lixeira:938895748295168033> | \`${member.user.tag}\` limpou a fila e excluiu ${amount} músicas.`)]
				})
			} catch (e) {
