...
module.exports = {
	name: "np", //the command name for the Slash Command
	category: "Musica",
	usage: "np",
	aliases: ["np"],
	description: "Faça o bot te enviar os dados da música que está tocando atualmente.", //the command description for Slash Command Overview
	cooldown: 5,
